...
```{r, message=FALSE, echo=FALSE}
model4.0 <- readRDS(here::here(paste0("models/model4.", 0, ".rds")))
model4.1 <- readRDS(here::here(paste0("models/model4.", 1, ".rds")))
model4.2 <- readRDS(here::here(paste0("models/model4.", 2, ".rds")))
model4.3 <- readRDS(here::here(paste0("models/model4.", 3, ".rds")))
model4.4 <- readRDS(here::here(paste0("models/model4.", 4, ".rds")))
model4.5 <- readRDS(here::here(paste0("models/model4.", 5, ".rds")))
model4.6 <- readRDS(here::here(paste0("models/model4.", 6, ".rds")))
model4.7 <- readRDS(here::here(paste0("models/model4.", 7, ".rds")))
model4.8 <- readRDS(here::here(paste0("models/model4.", 8, ".rds")))
model4.9 <- readRDS(here::here(paste0("models/model4.", 9, ".rds")))
model4.10 <- readRDS(here::here(paste0("models/model4.", 10, ".rds")))
```
...
```{r, message=FALSE, echo=FALSE}
load(here::here("data/bootstrapLRT/physics-boundary.rda"))
```
...
nullLRT = attr(phys_bootstrapLRT, "nulldist")
