...
- Based on the AIC, model corresponding to schools nested within districts is the best.
...
$$ICC(school) = \frac{\tau^{2}_{00}}{\tau^{2}_{00} + \phi^{2}_{00} + \sigma^2} = \frac{0.83408}{(0.83408 + 0.14864 + 0.17998)} = 0.7174$$

The **level-three ICC** refers to the correlation between different schools $i$ and $i^*$ from a specific school $j$. 

$$ICC(school) = \frac{\phi^2_{00}}{\tau^2_{00} + \phi^2_{00} + \sigma^2} = \frac{0.14864}{(0.83408 + 0.14864 + 0.17998)} = 0.1278$$
...
- The fixed effects, residual and random effects of schools nested within districts did not change much
  - Therefore, this reparameterisation is ok
...
Based on the AIC, model4.7 is the best.
...
# Full model
balt <- lmer(log_enrolments ~year92 + sector + unit + year92:sector + sector:unit +
               (year92 | qcaa_district:qcaa_school_id) +    
               (year92 | qcaa_district),
             REML = FALSE,
             control = lmerControl(optimizer = "bobyqa"),
...
# Null model
bnull <- lmer(log_enrolments ~year92 + sector + unit + year92:sector + sector:unit +
               (year92 | qcaa_district:qcaa_school_id) +    
               (1 | qcaa_district),
              REML = FALSE,
              control = lmerControl(optimizer = "bobyqa"),
