...
There is overwhelming statistical evidence ($\chi^2$ = 208.623 and $p$-value = 0 from Table \@ref(tab:earth-sci-bootstrapLRT-tab)) that the larger model (including random slope at level two) is the better model.
