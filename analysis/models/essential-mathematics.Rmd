...
As the random slopes are removed, all districts are predicted to have the same increase in enrolments over the years; And as was discussed previously, this was a reasonable assumption or an otherwise perfect correlation with random slope and intercept will be fitted. Figure \@ref(fig:ess-math-district-ranef) demonstrates that schools in Goal Coast has the largest enrolments while Mackay have the lowest enrolments in Biology subject, on average.
